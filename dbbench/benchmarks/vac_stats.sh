#awk '{ print "reads: ",$4,"\nreadMerged: ",$5,"\nr_sector: ",$6,"\nms_read: ",$7,"\nwrites: ",$8,"\nsect_written: ",$10,"\nwriteMerged: ",$9,"\nms_write", $11 }' < vda_stats.vacuum

reads_start=$(awk '{print $4}' < $1/vda_stats.vacuum)
readSect_start=$(awk '{print $6}' < $1/vda_stats.vacuum)
readMs_start=$(awk '{print $7}' < $1/vda_stats.vacuum)
writes_start=$(awk '{print $8}' < $1/vda_stats.vacuum)
writeSect_start=$(awk '{print $10}' < $1/vda_stats.vacuum)
writeMs_start=$(awk '{print $11}' < $1/vda_stats.vacuum)
